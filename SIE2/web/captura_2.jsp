                    ...
                    <div class="panel-footer">
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="codigo" class="form-control" id="codigo" name="codigo" placeholder="C. B." onKeyPress="return tabular(event, this)">
                                </div>
                                <div class="col-sm-1">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <input data-date-format="dd" type="text" class="form-control" id="fdd" name="fdd" placeholder="Día" onKeyPress="return handleEnter(this, even)" onkeyup="putDaysf()" maxlength="2" />
                                </div>
                                 <div class="col-sm-1">
                                    <input data-date-format="mm" type="text" class="form-control" id="fmm" name="fmm" placeholder="Mes" onKeyPress="return handleEnter(this, even)" onkeyup="putMonthssf()" maxlength="2" />
                                </div>
                                 <div class="col-sm-1">
                                    <input data-date-format="yyyy" type="text" class="form-control" id="faa" name="faa" placeholder="Año" onKeyPress="return handleEnter(this, even)" onkeyup="putYearssf()" maxlength="4" />
                                </div>
                            </div>
                        </div>
                                    <div class="form-group">
...
function putDaysf()
{
 var dayv = document.formulario1.fdd.value;
 if(dayv>=0 && dayv<=31)
 {
     var day = document.formulario1.fdd.value.length +1;
     if (day <= 2)
     {
         document.formulario1.fdd.focus()
     }
     ...
     {
         document.formulario1.fmm.focus()
     }
 }else
  {
      alert("DIA Fuera de Rango: "+dayv);
      document.formulario1.fdd.value="";
      document.formulario1.fdd.focus();
  }
}
function putMonthssf(){
   var month = document.formulario1.fmm.value.length +1;
   var monthv = document.formulario1.fmm.value;
   if(monthv>=0 && monthv<=12)
   {
       if (month <= 2)
       {
           ...
           document.formulario1.faa.focus()
       }
   }else{
       alert("MES Fuera de Rango: "+monthv);
       document.formulario1.fmm.value="";
       document.formulario1.fmm.focus();
   }
                      }
function putYearssf(formulario1){
    var year = document.formulario1.faa.value.length +1;
    var yearv = document.formulario1.faa.value;
    if (year <= 4){
        document.formulario1.faa.focus()
    }else{
    ...
    if(year==5){
        var d=new Date();
        var day= document.formulario1.fdd.value;
        var month=document.formulario1.fmm.value;
        var years=document.formulario1.faa.value;
        if( (yearv<=2009 || yearv>2018) || (day<d.getDate() && month<=(d.getMonth()+1) && yearv<=2010)){
            if( (yearv<=2009 || yearv>2018)){
                alert("Año Fuera de Rango: "+yearv);
                document.formulario1.faa.value="";
                document.formulario1.faa.focus();
            }
            if((day<d.getDate() && month<=(d.getMonth()+1) && yearv<=2010)){
                alert("Fecha Caduca, Fíjate Mano!: "+day+"/"+month+"/"+yearv);
...
function validaCapturaVacios() {
        ...
        if ($("#fdd").val()==""){missinginfo += "\n El campo Día Fabricación no debe de estar vacío";}
        if ($("#fmm").val()==""){missinginfo += "\n El campo Mes Fabricación no debe de estar vacío";}
        if ($("#faa").val()==""){missinginfo += "\n El campo Año Fabricación no debe de estar vacío";}
